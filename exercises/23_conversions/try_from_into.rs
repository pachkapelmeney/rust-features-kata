...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        let red = tuple.0.try_into().map_err(|x| IntoColorError::IntConversion);
        let green = tuple.1.try_into().map_err(|x| IntoColorError::IntConversion);
        let blue = tuple.2.try_into().map_err(|x| IntoColorError::IntConversion);
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        let red = arr[0].try_into().map_err(|x| IntoColorError::IntConversion);
        let green = arr[1].try_into().map_err(|x| IntoColorError::IntConversion);
        let blue = arr[2].try_into().map_err(|x| IntoColorError::IntConversion);
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        let red = slice[0].try_into().map_err(|x| IntoColorError::IntConversion);
        let green = slice[1].try_into().map_err(|x| IntoColorError::IntConversion);
        let blue = slice[2].try_into().map_err(|x| IntoColorError::IntConversion);
